  ...
  return (
    ...
    >
        <div className="bc---teamCard py-4 px-3 my-3 text-center" style={{minHeight:"300px"}} > 
            ...
            <p className="mt-3 pt-1">{props.name}</p>
            <p className="mt-3 pt-1" style={{color: '#ffcc0F'}}>{props.designation}</p>
            <p className="mt-3 pt-1" style={{minHeight: "50px"}}>{props.discription}</p>
            <div>
            {/* {props.facebook != '#' &&
